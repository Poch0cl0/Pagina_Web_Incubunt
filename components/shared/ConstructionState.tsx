...
const ConstructionState: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[400px] w-full text-center p-8 bg-gray-50/50 rounded-xl">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Estamos en ello</h2>
            <p className="text-gray-500 max-w-md">
                Estamos trabajando duro para traerte novedades increíbles. ¡Vuelve pronto!
            </p>
        </div>
    );
};
