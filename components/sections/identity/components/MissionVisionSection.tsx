...
function MissionVisionCardFlip({
  ...
  const transformStyle = `perspective(1000px) rotateX(${tilt.rx}deg) rotateY(${baseRotateY + tilt.ry * 0.1
    }deg)`;
  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT */}
        <div
          className={`absolute inset-0 flex flex-col items-center justify-center text-center p-2 rounded-2xl ${!isVision ? bgClass : ""
            }`}
          style={{
