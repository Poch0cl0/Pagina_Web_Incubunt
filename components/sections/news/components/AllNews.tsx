    ...
    return (
        <>
            ...
            <section className="relative max-w-[1600px] mx-auto bg-gray-50">
                <div className="absolute top-0 left-0 w-full h-[380px] bg-gradient-to-r from-[#001f4d] to-[#0056cc] z-0" />
                        ...
                        {[...Array(8)].map((_, i) => (
                            <div key={i} className="bg-[#1d1f20] text-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-transform transform hover:-translate-y-1" >
                                ...
                                <div className="p-5">
                                    ...
                                    <button onClick={() => router.push("/newsproyect")} className="bg-blue-600 text-white font-semibold px-4 py-2 rounded-full hover:bg-blue-700 transition flex items-center space-x-2">
                                        <span>Leer más</span>
